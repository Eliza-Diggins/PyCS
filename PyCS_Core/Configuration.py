...
#------------------------------------------------------ Variables ------------------------------------------------------#
#--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--#
with open(os.path.join(str(pt.Path(os.path.realpath(__file__)).parents[0]).replace(".py",""),"tkt","ticket.INSTALL_TICKET"),"r") as file:
...
def read_config(configuration_path:str)->dict:
    ...
    for key in config_dict["Visualization"]["ColorMaps"]:
        try:
            ...
            raise ValueError("%s Configuration key %s failed. %s is not a colormap."%(_fdbg_string,key,config_dict["Visualization"]["ColorMaps"][key]))
