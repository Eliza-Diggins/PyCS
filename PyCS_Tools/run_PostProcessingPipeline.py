...
commands_dict = {
    ...
    "Generate Image Sequence": {
        ...
        "options": {
            ...
            "-c": ("", "", "Include contours?"),
            "-c_qty": ("", "", "Include contours?"),
            "-c_lvls": ("", "", "Contour levels."),
            "-c_nlvl": ("", "", "Number of levels. Overriden by c_lvls"),
            "-c_log": ("", "", "Logarithmic contours?"),
            "-c_proj": ("", "", "Projected contours?"),
            "-c_smooth": ("", "", "Smooth contour map? (kernel)"),
            "-c_fam": ("", "", "Contour map families."),
            "-c_color": ("", "", "Contour colors."),
    ...
    "Generate Profile Sequence":{
        ...
        "options":{
            ...
            "-lw"    :("","","linewidth"),
            "-c"     :("","","color"),
            "-ylim"  :("","","Y limits to impose"),
            "-L"     :("","","Lambda"),
            "-lp": ("False", "False", "Generate a linear profile?"),
            "-LL"    :("","","Lambda label"),
            "-Ls": ("", "", "Lambda linestyle (MUST NOT HAVE -. use 'dashdot' etc.)"),
            "-Lw": ("", "", "Lambda linewidth"),
            "-Lc": ("", "", "Lambda color"),
            "-o"     : ("", "", "The logging output."),
            "-l"     : ("", "", "The debugging level."),
    ...
    "Generate DM-Baryon Image Sequence": {
        ...
        "options": {
            "-sim": ("", "", "The simulation name to use. Only one of -sim / -simdir is needed."),
            "-simdir": ("", "", "The simulation directory."),
            "-vg": ("", "", "The output range boundaries gas. (should be a string 'vmin vmax'"),
            "-vdm": ("", "", "The output range boundaries dm. (should be a string 'vmin vmax'"),
            "-w": (str(CONFIG["Visualization"]["Images"]["default_width"]),
                   str(CONFIG["Visualization"]["Images"]["default_width"]), "The width of the plotting area."),
            "-u": ("", "", "The output units"),
            "-tu": (str(CONFIG["units"]["default_time_unit"]), str(CONFIG["units"]["default_time_unit"]),
